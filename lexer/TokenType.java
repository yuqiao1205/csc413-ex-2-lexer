...
public class TokenType {
   ...
   public TokenType() {
     ...
     tokens.put(Tokens.DateType, Symbol.symbol("date",Tokens.DateType));
     ...
     tokens.put(Tokens.Break, Symbol.symbol("break",Tokens.Break));
     tokens.put(Tokens.Continue, Symbol.symbol("continue",Tokens.Continue));
     ...
     tokens.put(Tokens.DateLit, Symbol.symbol("<date>",Tokens.DateLit));
